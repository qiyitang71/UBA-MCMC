...
public class DTMCModelChecker extends ProbModelChecker
{
	 ...
	 */
	protected StateValues checkProbPathFormulaLTLViaUBA(DTMC model, Expression expr, boolean qual, BitSet statesOfInterest) throws PrismException
	{
	 ...
	 * Note: if 'known' is specified (i.e. is non-null), 'init' must also be given and is used for the exact values.
	 */
	public ModelCheckerResult computeReachProbsGaussSeidel(DTMC dtmc, BitSet no, BitSet yes, double init[], BitSet known) throws PrismException
	{
